...
///Questions
///1. 
let getCity = (pickedCity) => {
    if (pickedCity == evanstonWeather.city.name) {
        console.log(evanstonWeather.city.name)
        console.log("The coordinates of " + evanstonWeather.city.name + " are "
            + evanstonWeather.city.coord.lat + " latitude and " 
            + evanstonWeather.city.coord.lon + " longitude.")
    }
}
getCity("Evanston")
